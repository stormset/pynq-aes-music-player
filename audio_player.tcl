...
#
# audio_player.tcl: Tcl script for re-creating project 'audio_player'
#
# Generated by Vivado
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/constr/constraints.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "audio_player"
...
set script_file "audio_player.tcl"
...
set_property -name "customized_default_ip_location" -value "$proj_dir/rtl" -objects $obj
...
set file "[file normalize "$origin_dir/constr/constraints.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "constr/constraints.xdc"
...
proc cr_bd_block_design { parentCell } {
  ...
  user.org:user:AXI_aes_core:1.0\
  xilinx.com:user:I2S_slave:1.0\
  ...
  set ss [ create_bd_port -dir O -type intr ss ]
...
0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#USB Reset#GPIO#GPIO#GPIO#Enet\
0#Enet 0} \
    CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#reset#gpio[49]#gpio[50]#gpio[51]#mdc#mdio}\
\
  ...
  # Create instance: I2S_slave_0, and set properties
  set I2S_slave_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:I2S_slave:1.0 I2S_slave_0 ]
  ...
  connect_bd_intf_net -intf_net AXI_aes_core_0_M_AXIS_cipher [get_bd_intf_pins AXI_aes_core_0/M_AXIS_cipher] [get_bd_intf_pins fifo_generator_0/S_AXIS]
  connect_bd_intf_net -intf_net AXI_aes_core_0_M_AXIS_decipher [get_bd_intf_pins AXI_aes_core_0/M_AXIS_decipher] [get_bd_intf_pins fifo_generator_1/S_AXIS]
  connect_bd_intf_net -intf_net SPI_master_0_M_AXIS [get_bd_intf_pins SPI_master_0/M_AXIS] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_RXD]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins AXI_aes_core_0/S_AXIS_cipher]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins smartconnect_0/S03_AXI] [get_bd_intf_pins axi_dma_1/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_SG [get_bd_intf_pins smartconnect_0/S02_AXI] [get_bd_intf_pins axi_dma_1/M_AXI_SG]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXIS_MM2S [get_bd_intf_pins axi_dma_2/M_AXIS_MM2S] [get_bd_intf_pins AXI_aes_core_0/S_AXIS_decipher]
  ...
  connect_bd_intf_net -intf_net axi_dma_3_M_AXIS_MM2S [get_bd_intf_pins axi_dma_3/M_AXIS_MM2S] [get_bd_intf_pins I2S_slave_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_MM2S [get_bd_intf_pins axi_dma_3/M_AXI_MM2S] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_SG [get_bd_intf_pins axi_dma_3/M_AXI_SG] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_fifo_mm_s_0_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD] [get_bd_intf_pins SPI_master_0/S_AXIS]
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins fifo_generator_0/M_AXIS] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net fifo_generator_1_M_AXIS [get_bd_intf_pins fifo_generator_1/M_AXIS] [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_dma_3/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins AXI_aes_core_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_dma_2/S_AXI_LITE]
  ...
  connect_bd_net -net AXI_aes_core_0_cipher_fifo_rst [get_bd_pins AXI_aes_core_0/cipher_fifo_rst] [get_bd_pins fifo_generator_0/s_aresetn]
  connect_bd_net -net AXI_aes_core_0_decipher_fifo_rst [get_bd_pins AXI_aes_core_0/decipher_fifo_rst] [get_bd_pins fifo_generator_1/s_aresetn]
  connect_bd_net -net I2S_slave_0_sdata [get_bd_pins I2S_slave_0/sdata] [get_bd_ports sdata]
  connect_bd_net -net SPI_master_0_mosi [get_bd_pins SPI_master_0/mosi] [get_bd_ports mosi]
  connect_bd_net -net SPI_master_0_sclk [get_bd_pins SPI_master_0/sclk] [get_bd_ports sclk]
  connect_bd_net -net SPI_master_0_ss [get_bd_pins SPI_master_0/ss] [get_bd_ports ss]
  connect_bd_net -net axi_dma_1_mm2s_introut [get_bd_pins axi_dma_1/mm2s_introut] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net axi_dma_1_s2mm_introut [get_bd_pins axi_dma_1/s2mm_introut] [get_bd_pins xlconcat_1/In2]
  connect_bd_net -net axi_dma_2_mm2s_introut [get_bd_pins axi_dma_2/mm2s_introut] [get_bd_pins xlconcat_1/In3]
  connect_bd_net -net axi_dma_2_s2mm_introut [get_bd_pins axi_dma_2/s2mm_introut] [get_bd_pins xlconcat_1/In4]
  connect_bd_net -net axi_dma_3_mm2s_introut [get_bd_pins axi_dma_3/mm2s_introut] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net axi_fifo_mm_s_0_interrupt [get_bd_pins axi_fifo_mm_s_0/interrupt] [get_bd_pins xlconcat_1/In5]
  connect_bd_net -net bclk_1 [get_bd_ports bclk] [get_bd_pins I2S_slave_0/bclk]
  connect_bd_net -net lrclk_1 [get_bd_ports lrclk] [get_bd_pins I2S_slave_0/lrclk]
  connect_bd_net -net miso_1 [get_bd_ports miso] [get_bd_pins SPI_master_0/miso]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_sg_aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins fifo_generator_0/s_aclk] [get_bd_pins fifo_generator_1/s_aclk] [get_bd_pins axi_dma_2/m_axi_mm2s_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/m_axi_sg_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins axi_dma_3/m_axi_mm2s_aclk] [get_bd_pins axi_dma_3/m_axi_sg_aclk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins AXI_aes_core_0/s_axis_decipher_aclk] [get_bd_pins AXI_aes_core_0/s_axi_aclk] [get_bd_pins AXI_aes_core_0/s_axis_cipher_aclk] [get_bd_pins AXI_aes_core_0/m_axis_cipher_aclk] [get_bd_pins AXI_aes_core_0/m_axis_decipher_aclk] [get_bd_pins I2S_slave_0/S_AXIS_ACLK] [get_bd_pins SPI_master_0/AXIS_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_ports mclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins AXI_aes_core_0/s_axis_decipher_aresetn] [get_bd_pins AXI_aes_core_0/s_axi_aresetn] [get_bd_pins AXI_aes_core_0/s_axis_cipher_aresetn] [get_bd_pins AXI_aes_core_0/m_axis_cipher_aresetn] [get_bd_pins AXI_aes_core_0/m_axis_decipher_aresetn] [get_bd_pins I2S_slave_0/S_AXIS_ARESETN] [get_bd_pins SPI_master_0/AXIS_ARESETN]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins xlconcat_1/dout] [get_bd_pins processing_system7_0/IRQ_F2P]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_aes_core_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40414000 -range 0x00004000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_1/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40410000 -range 0x00004000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_2/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x40418000 -range 0x00004000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_3/S_AXI_LITE/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_2/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_2/Data_SG] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_3/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_3/Data_SG] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.830564",
   "Default View_TopLeft":"2159,-1193",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 3780 -y -1090 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 3780 -y -1070 -defaultsOSRD
preplace port port-id_mosi -pg 1 -lvl 6 -x 3780 -y -350 -defaultsOSRD
preplace port port-id_sclk -pg 1 -lvl 6 -x 3780 -y -370 -defaultsOSRD
preplace port port-id_ss -pg 1 -lvl 6 -x 3780 -y -330 -defaultsOSRD
preplace port port-id_sdata -pg 1 -lvl 6 -x 3780 -y -460 -defaultsOSRD
preplace port port-id_miso -pg 1 -lvl 0 -x -590 -y -550 -defaultsOSRD
preplace port port-id_mclk -pg 1 -lvl 6 -x 3780 -y -440 -defaultsOSRD
preplace port port-id_lrclk -pg 1 -lvl 0 -x -590 -y -440 -defaultsOSRD
preplace port port-id_bclk -pg 1 -lvl 0 -x -590 -y -460 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 3180 -y -880 -defaultsOSRD
preplace inst axi_fifo_mm_s_0 -pg 1 -lvl 3 -x 2250 -y -550 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 1040 -y -670 -defaultsOSRD
preplace inst smartconnect_0 -pg 1 -lvl 3 -x 2250 -y -920 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 1 -x 1040 -y -990 -defaultsOSRD
preplace inst axi_dma_1 -pg 1 -lvl 2 -x 1490 -y -1170 -defaultsOSRD
preplace inst fifo_generator_0 -pg 1 -lvl 3 -x 2250 -y -1190 -defaultsOSRD
preplace inst xlconcat_1 -pg 1 -lvl 4 -x 2670 -y -820 -defaultsOSRD
preplace inst AXI_aes_core_0 -pg 1 -lvl 5 -x 3180 -y -1230 -defaultsOSRD
preplace inst fifo_generator_1 -pg 1 -lvl 3 -x 2250 -y -1430 -defaultsOSRD
preplace inst axi_dma_2 -pg 1 -lvl 2 -x 1490 -y -1440 -defaultsOSRD
preplace inst axi_dma_3 -pg 1 -lvl 2 -x 1490 -y -590 -defaultsOSRD
preplace inst I2S_slave_0 -pg 1 -lvl 5 -x 3180 -y -410 -defaultsOSRD
preplace inst SPI_master_0 -pg 1 -lvl 5 -x 3180 -y -610 -defaultsOSRD
preplace netloc AXI_aes_core_0_cipher_fifo_rst 1 2 4 2090 -740 2440J -1010 NJ -1010 3390
preplace netloc AXI_aes_core_0_decipher_fifo_rst 1 2 4 2080 -710 NJ -710 NJ -710 3400
preplace netloc I2S_slave_0_sdata 1 5 1 3430 -460n
preplace netloc SPI_master_0_mosi 1 5 1 3410 -600n
preplace netloc SPI_master_0_sclk 1 5 1 3420 -620n
preplace netloc SPI_master_0_ss 1 5 1 3400 -580n
preplace netloc axi_dma_1_mm2s_introut 1 2 2 NJ -1090 2450J
preplace netloc axi_dma_1_s2mm_introut 1 2 2 1680J -750 2470J
preplace netloc axi_dma_2_mm2s_introut 1 2 2 1700J -730 2490
preplace netloc axi_dma_2_s2mm_introut 1 2 2 2070J -1320 2460
preplace netloc axi_dma_3_mm2s_introut 1 2 2 2060 -720 2480J
preplace netloc axi_fifo_mm_s_0_interrupt 1 3 1 2500 -770n
preplace netloc bclk_1 1 0 5 NJ -460 NJ -460 NJ -460 NJ -460 2780
preplace netloc lrclk_1 1 0 5 NJ -440 NJ -440 NJ -440 NJ -440 2770J
preplace netloc miso_1 1 0 5 NJ -550 1210J -690 NJ -690 NJ -690 2980
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 850 -1190 1310 -1580 1990 -1270 N -1270 2960 -760 3390
preplace netloc processing_system7_0_FCLK_CLK1 1 5 1 3440 -840n
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 870 -770 N -770 1650 -700 N -700 N -700 3380
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 5 860 -780 1270 -830 2000 -680 N -680 2970
preplace netloc xlconcat_1_dout 1 4 1 N -820
preplace netloc AXI_aes_core_0_M_AXIS_cipher 1 2 4 2090 -1340 2410J -1420 NJ -1420 3390
preplace netloc AXI_aes_core_0_M_AXIS_decipher 1 2 4 2090 -1350 2420J -1410 NJ -1410 3440
preplace netloc SPI_master_0_M_AXIS 1 2 4 2090 -650 NJ -650 2800J -520 3380
preplace netloc axi_dma_1_M_AXIS_MM2S 1 2 3 1660 -1330 NJ -1330 NJ
preplace netloc axi_dma_1_M_AXI_MM2S 1 2 1 2040 -1250n
preplace netloc axi_dma_1_M_AXI_S2MM 1 2 1 2020 -1230n
preplace netloc axi_dma_1_M_AXI_SG 1 2 1 1650 -1270n
preplace netloc axi_dma_2_M_AXIS_MM2S 1 2 3 1700J -1510 NJ -1510 2820
preplace netloc axi_dma_2_M_AXI_MM2S 1 2 1 2060 -1490n
preplace netloc axi_dma_2_M_AXI_S2MM 1 2 1 2050 -1470n
preplace netloc axi_dma_2_M_AXI_SG 1 2 1 1670 -1510n
preplace netloc axi_dma_3_M_AXIS_MM2S 1 2 3 2080J -640 NJ -640 2790J
preplace netloc axi_dma_3_M_AXI_MM2S 1 2 1 2030 -990n
preplace netloc axi_dma_3_M_AXI_SG 1 2 1 2010 -1010n
preplace netloc axi_fifo_mm_s_0_AXI_STR_TXD 1 3 2 NJ -580 2810
preplace netloc fifo_generator_0_M_AXIS 1 1 3 1330 -760 NJ -760 2410
preplace netloc fifo_generator_1_M_AXIS 1 1 3 1330 -1570 NJ -1570 2410
preplace netloc processing_system7_0_DDR 1 5 1 3410 -1090n
preplace netloc processing_system7_0_FIXED_IO 1 5 1 3440 -1070n
preplace netloc processing_system7_0_M_AXI_GP0 1 0 6 870 -790 NJ -790 1670J -770 2420J -1000 NJ -1000 3390
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 2 1320 -1010 1660J
preplace netloc ps7_0_axi_periph_M01_AXI 1 1 1 1280 -1010n
preplace netloc ps7_0_axi_periph_M02_AXI 1 1 4 1300 -1000 1690J -1290 NJ -1290 2790J
preplace netloc ps7_0_axi_periph_M03_AXI 1 1 1 1290 -1240n
preplace netloc ps7_0_axi_periph_M04_AXI 1 1 1 1210 -1500n
preplace netloc smartconnect_0_M00_AXI 1 3 2 2430 -930 2980
levelinfo -pg 1 -590 1040 1490 2250 2670 3180 3780
pagesize -pg 1 -db -bbox -sgen -690 -2150 3900 760
"
}
...
cr_bd_block_design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files block_design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files block_design.bd ] 
set_property IS_ENABLED "1" [get_files block_design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files block_design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files block_design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files block_design.bd ] 
set_property PFM_NAME "" [get_files block_design.bd ] 
...
set_property USED_IN "synthesis implementation simulation" [get_files block_design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files block_design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files block_design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files block_design.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list block_design.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/audio_player/audio_player.gen/sources_1/bd/block_design/hdl/block_design_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list block_design.bd]] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/audio_player.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/audio_player.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/audio_player.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
